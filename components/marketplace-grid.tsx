...
const marketplaceItems: MarketplaceItem[] = [
  {
    ...
    description:
      "Rare weapon from CryptoQuest with +500 attack power and fire enchantment",
    price: "3.2 SUI",
    category: "Gaming",
    seller: {
      name: "DragonMaster",
  ...
  },
  {
    ...
    description:
      "Stunning digital artwork by renowned crypto artist with certificate of authenticity",
    price: "2.8 SUI",
    category: "Art",
    seller: {
      name: "ArtistPro",
  ...
  },
  {
    ...
    description:
      "Customizable avatar with rare traits and exclusive accessories",
    price: "1.5 SUI",
    category: "Gaming",
    seller: {
      name: "AvatarCreator",
  ...
  },
  {
    ...
    description:
      "Prime location in MetaCity with development rights and resource access",
    price: "5.0 SUI",
  ...
  },
  {
    ...
    description:
      "Exclusive music tracks with royalty sharing and backstage access",
    price: "2.2 SUI",
    category: "Music",
    seller: {
      name: "MusicProducer",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
          {marketplaceItems
            ...
            .map((item) => (
              <Card
                key={item.id}
                className="bg-card border-border hover:border-veralux-green/50 transition-colors"
              >
                <CardContent className="p-0">
                  ...
                  <div className="p-3 sm:p-4 lg:p-6">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2 mb-2">
                          <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-card-foreground truncate">
                            {item.title}
                          </h3>
                      ...
                      <div className="text-right ml-2">
                        <p className="text-lg sm:text-xl lg:text-2xl font-bold text-veralux-green">
                          {item.price}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2 min-w-0">
                        ...
                        <div className="flex items-center space-x-1 min-w-0">
                          ...
                          {item.seller.verified && (
                            <div className="w-2 h-2 sm:w-3 sm:h-3 bg-veralux-green rounded-full flex items-center justify-center flex-shrink-0">
                              <span className="text-white text-xs">✓</span>
                            </div>
                          )}
                        </div>
                        <div className="flex items-center space-x-1">
                          <span className="text-veralux-yellow text-xs sm:text-sm">
                            ⭐
                          </span>
                      ...
                      <Button className="bg-veralux-green hover:bg-veralux-green/90 text-white flex-shrink-0 text-xs sm:text-sm px-3 py-1 h-6 sm:h-8">
                        Buy Now
                      </Button>
                    </div>
                  </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-2 sm:p-3 lg:p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-1 mb-1">
                        <h3 className="text-xs sm:text-sm lg:text-base font-semibold text-card-foreground truncate">
                          {item.title}
                        </h3>
                        {item.escrowProtected && (
                          <div className="w-2 h-2 sm:w-3 sm:h-3 bg-veralux-green rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <p className="text-sm sm:text-base lg:text-lg font-bold text-veralux-green ml-2 flex-shrink-0">
                      {item.price}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      size="sm"
                      className="bg-electric-blue hover:bg-electric-blue/90 text-white text-xs px-2 py-1 h-6 sm:h-7 flex-shrink-0"
                    >
                      Buy
                    </Button>
                  </div>
