  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <Card className="bg-card border-border">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-veralux-green">1,247 ETH</div>
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-card-foreground">8,934</div>
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-electric-blue">2,156</div>
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-veralux-yellow">2.3 ETH</div>
