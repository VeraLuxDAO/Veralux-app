...
const games: Game[] = [
  {
    ...
    title: "CryptoQuest",
    description:
      "Epic fantasy RPG with NFT characters and blockchain-based item trading",
    genre: "RPG",
    players: "12.4K",
    rating: 4.8,
  ...
  },
  {
    ...
    title: "DeFi Warriors",
    description:
      "Strategic battle game where you fight with DeFi protocols as weapons",
    genre: "Strategy",
    players: "8.7K",
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "High-speed racing with customizable NFT cars and track ownership",
    genre: "Racing",
    players: "6.2K",
    rating: 4.5,
  ...
  },
  {
    ...
    description:
      "Create and monetize virtual worlds with integrated marketplace",
    genre: "Simulation",
    players: "4.8K",
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Provably fair poker with cryptocurrency stakes and NFT avatars",
    genre: "Card Game",
    players: "15.6K",
    rating: 4.4,
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm font-semibold text-veralux-green">
                          {game.earnings}
                        </p>
                      </div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs font-semibold text-veralux-green">
                        {game.earnings}
                      </p>
                    </div>
                    <Button
