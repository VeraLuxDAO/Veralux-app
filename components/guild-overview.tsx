  ...
  return (
    <div className="space-y-6">
      ...
      <Card
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(229, 247, 253, 0.08) 0%, rgba(229, 247, 253, 0.02) 100%)",
          border: "1px solid rgba(250, 222, 253, 0.15)",
        }}
      >
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-card-foreground">
              CryptoQuest Guild Alpha
            </CardTitle>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xl font-semibold text-veralux-green">
                  234.7 ETH
                </p>
              </div>
            </div>
            ...
            {/* Guild Actions */}
            <div className="space-y-3">
              <Button className="w-full bg-veralux-yellow hover:bg-veralux-yellow/90 text-black">
                Manage Guild
              </Button>
              <Button
                variant="outline"
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center space-x-3 p-3 rounded-lg bg-card/50"
                >
