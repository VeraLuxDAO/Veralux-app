...
export function MarketplaceFilters() {
  const categories = ["Gaming", "Art", "Music", "Virtual Land", "Collectibles", "Utility"]
  ...
  return (
    <Card className="bg-card border-border">
      ...
      <CardContent className="space-y-4">
        ...
        {/* Price Range */}
        <div>
          <h4 className="text-sm font-medium text-card-foreground mb-2">Price Range (ETH)</h4>
          <div className="space-y-3">
            ...
            <Slider defaultValue={[0, 10]} max={10} step={0.1} className="w-full" />
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-card-foreground">0.0 ETH</span>
              <span className="text-xs font-medium text-card-foreground">10.0 ETH</span>
            </div>
          </div>
        </div>
        ...
        {/* Rarity Filter */}
        <div>
          <h4 className="text-sm font-medium text-card-foreground mb-2">Rarity</h4>
          <div className="space-y-2">
            {rarities.map((rarity) => (
              <div key={rarity} className="flex items-center space-x-2">
                <Checkbox id={rarity} />
                <label htmlFor={rarity} className="text-sm text-muted-foreground cursor-pointer">
                  {rarity}
                </label>
              </div>
            ))}
        ...
        {/* Seller Verification */}
        <div>
          <h4 className="text-sm font-medium text-card-foreground mb-2">Seller</h4>
          <div className="space-y-2">
